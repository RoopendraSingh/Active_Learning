...
output_folder="/root/preprocess-3/root/Anshit/NEW_DATA/upper_retrain_ckpts"
...
final_model_path="testing_scripts_training/final_compare_weights/upper/"
...
python3 Train_Upper.py  --old_data_path=${old_data_folder} --new_data_path=${new_data_folder} --output_dir=${output_folder} --old_model_path=${old_model_path} --final_model_path=${final_model_path}
echo "Job completed"