...
#     new_data_path_lower = new_data_path + "/Lower"
    ...
    get_data_upper(defective_path, non_defective_path, new_data_path_upper)
    
    # get the new images, augment them and merge to original images
    x = run_augment(new_data_path_upper)
    if(x != 0):
        Delete_random_files(old_data_path+"/train/0",x)
        
    Copy(new_data_path_upper+'/train_new_augmented/1',old_data_path+'/train_new_augmented/1')
    Copy(new_data_path_upper+'/train_new_augmented/0',old_data_path+'/train_new_augmented/0')
    Copy(new_data_path_upper+'/test/1',old_data_path+'/validation/1')
    Copy(new_data_path_upper+'/test/0',old_data_path+'/validation/0')
...
#     train_model(final_data_path,model_ckpt_path)
    ...
    retrain_model_path = model_ckpt_path+'/saved-model-augmented-gpu-22.h5'
